function SimpleTable(placeholder, metadata, data,tableclassname,pagesize,rowsettings) {
					...
					if($(this).attr('sortable') =='true') {
						if($(this).attr('sortDirection') =='none') {
							...
							if($(this).attr('sortDirection') =='down') {
								...
								tableInstance.applyFilter(tableInstance);
	...
	this.applyFilter = function(event) {
				...
				var tableInstance = (event.data!= null)?event.data:event;
